...
<head>
    ...
    <title>SWABE APPREL | ALL PRODUCTS</title>
...
<body>
            ...
            <div class="px-4">
                ...
                <div class="collapse navbar-collapse" id="navbarScroll">
                    <ul class="navbar-nav mx-auto my-2 my-lg-0 justify-content-center w-100">
                        ...
                        <li class="nav-item"><a class="nav-link link-hover" href="#allproducts.php">All Products</a>
                        </li>
    ...
    <div class="container section-content">
        <h1 class="mb-4 mt-5">All Products</h1>
