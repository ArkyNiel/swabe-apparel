...
<body>
    ...
    <div class="container section-content">
        <h1 class="mb-5 mt-5 text-center" style="letter-spacing: 0px;">hot sales</h1>
        ...
        <div class="text-center my-4" id="load-more-container"
            style="display: <?php echo isset($limitedProductsData['hasMore']) && $limitedProductsData['hasMore'] ? 'block' : 'none'; ?>">
