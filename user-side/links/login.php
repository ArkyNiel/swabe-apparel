...
<?php include('../components/loader.php'); ?>
    <div class="container-fluid auth-container d-flex align-items-center justify-content-center">
        <div class="row w-100 shadow rounded-1 overflow-hidden" style="max-width: 900px; height: 500px; background: #101820 !important;">
            <!-- Branding -->
                    ...
                    <form action="../../back-end/user-side/login_process.php" method="POST" autocomplete="off">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <input type="password" class="form-control" style="background-color: #e2e2cfff !important;" id="password" name="password" required>
