                ...
                <div class="navbar-icons">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" style="background-color: #fcfcea !important; min-width: 200px !important;">
                            ...
                            <?php else: ?>
                                <li><a class="dropdown-item link-hover" href="../../user-side/auth/login.php" style="color: #101820 !important; text-decoration: none !important; text-transform: uppercase !important;">Log In</a></li>
                            <?php endif; ?>
                        </ul>
                    </div>
                </div>
